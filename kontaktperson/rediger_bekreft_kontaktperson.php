 ...
 * @Last Modified time: 2026-03-06 13:43:08
 */
...
if(isset($_GET['rediger_kontaktperson']) AND ($_SERVER['REQUEST_METHOD'] == 'GET'))
    ...
    $sql = "UPDATE kontaktperson SET navn = :navn, etternavn = :etternavn, telefonnummer = :telefonnummer, epost = :epost, kunde_id = :kunde_id
